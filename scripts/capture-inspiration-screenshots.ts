...
const overrides: Partial<Record<string, Partial<Target>>> = {
	...
	"sources/collect-ui": { waitMs: 3_000 },
	"sources/codrops": { waitMs: 4_000 },
	"sources/muzli": { waitMs: 4_000 },
	"sources/designspiration": { waitMs: 4_000 },
	"sources/design-spells": { waitMs: 4_000 },
	"sources/loadmore": { waitMs: 4_000 },
	"sources/seesaw": { waitMs: 4_000 },
	"sources/game-ui-database": { waitMs: 4_000 },
	"sources/threeui": { waitMs: 5_000 },
	"sources/boardui": { waitMs: 5_000 },
	"sources/inspora": { waitMs: 4_000 },
	"sources/refero-styles": { waitMs: 4_000 },
	"sources/60fps-design": { waitMs: 5_000 },
	"sources/navbar-gallery": { waitMs: 4_000 },
	"sources/uigradients": { waitMs: 3_000 },
	"sources/cta-gallery": { waitMs: 4_000 },
	"sources/logobook": { waitMs: 4_000 },
	...
	"sites/metalforge": { captureUrl: "https://metalforge.xyz/", waitMs: 4_000 },
	"sites/aman": {
