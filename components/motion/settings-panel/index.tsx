...
/** Normalizes to an uppercase `#RRGGBB`; `null` when `input` isn't a valid hex color. */
...
/** YIQ perceived brightness — >= 150 reads as a light swatch. Parse failures count as dark. */
