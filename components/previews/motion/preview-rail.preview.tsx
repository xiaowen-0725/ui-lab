...
export const previewRailItems = [
  ...
  },
  {
    id: "templates",
    label: "Templates",
    description: "Start from polished layouts built with UI Lab components.",
    href: "#templates",
  },
  {
    id: "guides",
  ...
  },
  {
    id: "community",
    label: "Community",
    description: "Discover what other builders are creating with UI Lab.",
    href: "#community",
  },
  {
    id: "github",
  ...
  },
  {
    id: "about",
    label: "About",
    description: "Learn more about the ideas and people behind UI Lab.",
    href: "#about",
  },
];
